...
def _resolve_log_paths() -> tuple[str, str]:
    """
    Build the CSV and PNG log paths inside drone-student/labs/logs/.
    ...
    """
    # labs/ lives at <library_root>/../labs/, regardless of which drone-venv or
    # CWD the student runs from. __file__ is drone-student/library/telemetry.py.
